...
func TestConfigFieldTags_EnvTagPresent(t *testing.T) {
	...
	cases := []struct {
		...
		{"PublicFeedTokenRateLimit", "PUBLIC_FEED_TOKEN_RATE_LIMIT"},
		{"PublicCheckoutTokenRateLimit", "PUBLIC_CHECKOUT_TOKEN_RATE_LIMIT"},
		{"PublicAPIIPRateLimit", "PUBLIC_API_IP_RATE_LIMIT"},
...
func TestConfigFieldTags_DefaultTagOnNonRequiredFields(t *testing.T) {
	...
	optionalWithDefaults := []struct {
		...
		{"HTTPListenAddr", ":8080"},
		{"TrustedProxyCount", "0"},
		{"PublicFeedTokenRateLimit", "20000"},
		{"PublicCheckoutTokenRateLimit", "120"},
		{"PublicAPIIPRateLimit", "600"},
