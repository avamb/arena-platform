...
| 5 | interactive (Fable 5) | AB-49, AB-48, AB-41 | **IN PROGRESS 2026-08-21 (this session)** — NOTE: the `blocked→unavailable` rename part of AB-49 already landed with pass 1 (folded into 0081); AB-40 C2 bulk session add carried here (pairs with AB-48 bulk pricing) |
