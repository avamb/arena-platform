...
| 3 | interactive (Fable 5) | AB-40 A/B/C, AB-51 | **in progress 2026-08-05** — A/B + AB-51 backend done (migrations 0083/0084). AB-51 §6 burst RECORDED: 130 concurrent buyers x 5 tickets over 590 GA units = 1.51s wall, ~11.6ms avg/hold, exactly 118 wins / 12 over-capacity, zero deadlocks, unit rows == ledger rollup (integration test TestGAUnits_OnSaleBurst_LiveDB, local dockerized PG17) |
